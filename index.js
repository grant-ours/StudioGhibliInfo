//Making these variables global so they can be accessed from anywhere in the code
let characters;
let button;
  ...
  .then((movies) => {
    ...
    movies.forEach((movie) => {
      ...
      span.addEventListener("click", (event) => {
        ...
        const directorB = "Director: ";
        directorAndProducer.innerText = `${directorB}${movie.director}  |  Producer: ${movie.producer}`;
        ...
        //Event listener for title change to Japanese
        ...
        //If Statements to Remove Extra Banner Images/Buttons
        if (oldBannerImg) {
          oldBannerImg.remove();
        }
        if (oldBannerBtn) {
        ...
        //Click Event For Movie Banner Button
